...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tymbl.dashboard.pages', compact('title', 'pages'));
    }
    ...
    {
        $title = trans('app.pages');
        return view('tymbl.dashboard.page_create', compact('title'));
    }
    ...
    public function edit($slug)
    {
        ...
        return view('tymbl.dashboard.page_edit', compact('title', 'page', 'slug'));
    }
    ...
    public function updatePage(Request $request, $slug){
        ...
        $post_update = $page->update($data);
        if ($post_update){
            return redirect()->route('pages')->with('success', trans('app.page_has_been_updated'));
        }
        return redirect()->back()->with('error', trans('app.error_msg'));
    }
    ...
    public function showPage($slug){
        ...
        $title = $page->title;
        return view('tymbl.single_page', compact('title', 'page'));
    }
    ...
    public function howItWorks(){
      $title = 'HOW IT WORKS';
      return view('tymbl.how_it_works', compact('title'));
    }
